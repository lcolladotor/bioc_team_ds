...
If you have a Zoom account, please add the Zoom details to the calendar invitation ^[If you are using Google Calendar, there is a Google Calendar Zoom integration. The Outlook version LIBD uses does not support the Zoom integration, so you'll have to add the information manually to the calendar invitation.]. Thanks!
