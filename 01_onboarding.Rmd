...
* Setup password-less login through [ssh key pairs](https://jhpce.jhu.edu/knowledge-base/authentication/ssh-key-setup/).
  * One keypair for your laptop to the JHPCE login node
  * One keypair from the JHPCE login node to the compute nodes (typically created by JHPCE admins)
  * One keypair from your laptop to GitHub; see their [documentation](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent)
  * One keypair from JHPCE to GitHub
  * Check the LIBD rstats club videos on JHPCE laptop configuration (macOS and winOS versions)
