...
If you are either new to my team or [LIBD](https://www.libd.org/), you might this page useful. Note that each LIBD prinpical investigator (PI) might decide to do things differently. Some of the content here comes from [jaffe_onboarding](http://research.libd.org/jaffe_onboarding), which was actively used from Sep 8, 2019 till Sep 2020.
...
<a href="https://towardsdatascience.com/learning-curve-effect-on-the-global-variable-renewable-energy-deployment-73d1e28da390"><img src="https://miro.medium.com/max/1400/1*kBAHDORDg0bw1g9m7h2J0g.jpeg"/></a>
...
If you are overwhelmed, schedule a [**Data Science guidance session**](#data-science-guidance-sessions) (DSgs) and we'll help you get started by pointing you to the relevant parts appropriate to you. For example, we can help you make a list of useful resources or videos to watch from the LIBD [**rstats club schedule**](https://docs.google.com/spreadsheets/d/1is8dZSd0FZ9Qi1Zvq1uRhm-P1McnJRd_zxdAfCRoMfA/edit?usp=sharing), as well as from the [**team presentations schedule**](https://docs.google.com/spreadsheets/d/1r6552ySisg7_KpmJmChOvLHVWdMmss3bncEf2jqIM9k/edit?usp=sharing); both are available as YouTube playlists. These videos help clone ourselves so we can reach more people. This follows the same idea about writing a blog post if 3 people ask the same question (more on this further below).
...
### Single Cell RNA-seq and Spatial Trasncriptomics  

* [Human Pilot Visium](https://doi.org/10.1038/s41593-020-00787-0)  
* [Single Nucleus RNA-seq across human brain](https://www.cell.com/neuron/fulltext/S0896-6273(21)00655-3)  
...
* [R Markdown documentation website](https://rmarkdown.rstudio.com/docs/) announced by [Alison Hill](https://bsky.app/profile/apreshill.com) on [this post](https://twitter.com/apreshill/status/1171290891157307392?s=20).
...
* [slurmjobs](https://research.libd.org/slurmjobs/) R package writen by Nick Eagles, provides helper functions for interacting with SLURM-managed high-performance-computing environments from R   
...
* We have multiple Slack workspaces, though the main one we use is the JHU Genomics Slack which has over 500 members across many JHU and LIBD genomics teams. Ask your PI or Leonardo Collado-Torres to add you to that Slack workspace. Our main team channel is [`#libd_team_lcolladotor`](https://jhu-genomics.slack.com/archives/C01AD6PQHNW).
...
* You should specify your email on your JHPCE `~/.slurm/defaults` file following the information we have at the ["config files"](#config-files) page.
...
* [Environment modules](https://jhpce.jhu.edu/knowledge-base/environment-modules/) are useful so you don't have to install some common software from scratch, such as `R` which you can load using `module load conda_R`.
...
* `r BiocStyle::Githubpkg('LieberInstitute/slurmjobs')` ([documentation](http://lieberinstitute.github.io/slurmjobs)): contains helper functions for writing and interacting with SLURM jobs at JHPCE.
* [Array and Sequential Cluster Jobs](https://hopstat.wordpress.com/2013/11/05/array-and-sequential-cluster-jobs/). See also `slurmjobs::job_single()`.
...
One miscellaneous thing about using JHPCE to keep in mind:

* there's a 100G storage limit on your home directory `/users/[yourusername]/`, which will likely fill up very quickly. Generally, work for a given proect should be done under the project-specific directory (likely on the `/dcs04` or `/dcs05` filesystems), where there is far more space.
...
* `r BiocStyle::Githubpkg('LieberInstitute/slurmjobs')` ([documentation](http://lieberinstitute.github.io/slurmjobs)): contains helper functions for writing and interacting with SLURM jobs at JHPCE. We have several videos on `slurmjobs` at the [**rstats club schedule**](https://docs.google.com/spreadsheets/d/1is8dZSd0FZ9Qi1Zvq1uRhm-P1McnJRd_zxdAfCRoMfA/edit?usp=sharing).
...
* [**Koco**](https://www.facebook.com/kocotruck/) - Korean food on Tuesdays and Fridays. A lab favorite! Favorites are bulgogi (beef) and tofu dishes.
...
* ["So you're moving to Baltimore"](https://simplystatistics.org/posts/2013-09-13-so-youre-moving-to-baltimore/) 2013 blog post by [Brian Caffo](https://sites.google.com/view/bcaffo/home/).
