...
* there's a 100G storage max on your home directory `/users/[yourusername]/`, which will likely fill up very quickly. Most of us have directories under the `/dcs04`, `/dcl01`, and `/dcl02` filesystems, where there is far more space.
...
* for scripts/jobs where you are generating large files, you will need to change the maximum writeable file size. This is the `h_fsize` flag for bash scripts, which defaults to 10G. See https://jhpce.jhu.edu/knowledge-base/how-to/ for more details.
