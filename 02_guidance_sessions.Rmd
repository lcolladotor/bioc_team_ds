...
<div id="hello" class="greeting message" style="color: red;">
  <strong>Guides are show in order of their availability (most to least).</strong> Please try reaching out to multiple people instead of one person for all your questions. Thank you!
</div>
