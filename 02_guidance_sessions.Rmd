...
You can think about the _Data Science guidance sessions_ (**DSgs**) as _open office hours_. Also for several of us (Cynthia, Nick, Louise, and Leo), these DSgs'es are part of our job at LIBD. So please don't think that you are imposing in any way: we want to help you! Here are the quick links for signing up:

<center>
<img src="images/open_office_hours.png">
</center>

Leo's team:

* Cynthia Soto Cardinault
  - **Sign up** via [Calendly](https://calendly.com/cynthiacardinault/25-min-data-science-guidance-session)
* Nicholas J. Eagles
  - **Sign up** via [Calendly](https://calendly.com/nick-eagles/25-minute-data-science-guidance-session)
* Louise A. Huuki-Myers
  - **Sign up** via [Calendly](https://calendly.com/lahuuki/25-min-data-science-guidance-session)
* Hédia Tnani
  - **Sign up** via [Calendly](https://calendly.com/hediatnani/25-min-data-science-guidance-session)
* Leonardo Collado-Torres
  - **Sign up** via [Calendly](https://calendly.com/lcolladotor/ds-guidance)
  
External to Leo's team:

* Madhavi Tippani
  - **Sign up** via [Calendly](https://calendly.com/madhavitippani/25-minute-data-science-guidance-session)
  
Further below you'll see these links again after we:

* explain the _background_ behind DSgs
* some _rules_ we have,
* how you can _help us help you_,
* _information we might need_,
* which are our _research interests_ and how you can sign up.
...
These are 25 minute sessions where we'll try our best to help you, teach you, troubleshoot with you, and overall guide you as much as we can. You can think of DSgs as _open office hours_. It is how we contribute to the LIBD's data science capacity growing goals, and for several of us, providing DSgs sessions is part of our job at LIBD.
...
Note that Hédia can only do DSgs sessions related to the CHESS-BRAIN or qsvaR projects. She can also do internal team DSgs sessions on any topic.
...
Here's the list of people outside Leo's team that also provide DSgs sessions:
