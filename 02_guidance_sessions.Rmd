...
* Manisha Barse
  - **Sign up** via [Calendly](https://calendly.com/manishabarse/25-minute-data-science-guidance-session)
* Nicholas J. Eagles
...
We understand that you might be stressed or under significant pressure, but please follow our [code of conduct](https://research.libd.org/rstatsclub/#coc) ^[We will update the code of conduct once Bioconductor publishes their latest code of conduct in the Fall of 2020.]. Otherwise, we will forced to stop meeting with you.
...
* [Cynthia Soto Cardinault](https://github.com/cyntsc) ([BioC Support](https://support.bioconductor.org/u/59591/))
  ...
  - **Sign up** via [Calendly](https://calendly.com/cynthiacardinault/25-min-data-science-guidance-session)
* [Manisha Barse](https://github.com/manishabarse) ([BioC Support](https://support.bioconductor.org/u/59591/))
