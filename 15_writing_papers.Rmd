...
On 2020-04-06 I presented at [how to write papers using Google Docs](https://docs.google.com/document/d/1yumuVwZmpoE_SpcM-9AsU0U6D9R051vU8s_AGhoqh7Y/edit?usp=sharing). The video and notes mostly highlight these tools including [`Lean Library Workspace`](https://twitter.com/Sciwheel) (formerly `SciWheel` and `F1000Workspace`) and [`CrossReference`](https://github.com/davidrthorn/cross_reference).
