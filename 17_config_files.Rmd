...
As noted in the [2025-03-14 Automatic R/Bioconductor code formatting](https://youtu.be/OoVBiO_Oc2k) _LIBD RStats club_ session (check the [notes here](https://docs.google.com/document/d/1g0fc5DNED6Oy4tcspYqzJoRInm4Q4T4XUxwfeO9Hb5A/edit?usp=sharing)), I recommend:

* Use `styler` for auto-styling many files without having to open them one by one
  * [Example](https://github.com/lcolladotor/biocthis/blob/6ac0f68e12b40056743fe2efe1f482879a08265b/dev/04_update.R#L9-L22 )
