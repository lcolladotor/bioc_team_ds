...
BiocManager::install(c(
    "biocthis",
    "brainflowprobes",
    "DeconvoBuddies", ## under review at BioC
    "derfinder",
    "derfinderPlot",
    "GenomicState",
    "megadepth",
    ...
    "spatialLIBD",
    "TREG",
    "visiumStitched" ## accepted at BioC but not yet available from it
...
remotes::install_github(c(
    ...
    # "LieberInstitute/shinycsv", ## Not really used anymore
...
if [[ $HOSTNAME == compute-* ]] || [[ $HOSTNAME == transfer-* ]]; then
	...
	module load git-lfs
	module load rmate
	module load conda_R/4.4.x ## for BioC 3.20
fi
