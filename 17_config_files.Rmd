...
After setting up the appropriate SSH keys, the Positron IDE can be used for coding at JHPCE. In contrast with RStudio, Positron can directly see the remote filesystem at JHPCE, plot interactively, and leverage additional AI features.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/CnmaJG8VPp8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
