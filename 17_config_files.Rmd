...
if [[ $HOSTNAME == compute-094.* ]] || [[ $HOSTNAME == compute-111.* ]]; then
    echo "Adding LIBD SLURM module aliases"
	alias modsrc="cd /jhpce/shared/libd/core"
	alias modlua="cd /jhpce/shared/libd/modulefiles"
else
    echo "Adding LIBD SGE module aliases"
...
if [[ $HOSTNAME == compute-* ]] || [[ $HOSTNAME == transfer-* ]]; then
	if [[ $HOSTNAME == compute-094.* ]] || [[ $HOSTNAME == compute-111.* ]]; then
	    echo "Adding LIBD SLURM modules"
