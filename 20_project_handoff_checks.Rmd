...
* Are the scripts linear? That is, can they be re-run from line 1 till the end linearly?
  * Ideally: are there companion shell scripts for the R scripts? For example, [`run_all_post_spaceranger.sh`](https://github.com/LieberInstitute/Visium_IF_AD/blob/master/code/run_all_post_spaceranger.sh).
